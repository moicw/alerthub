...
class ProcessAlertDigest implements ShouldQueue, ShouldBeUnique
{
     ...
     * subscriber, date, and alert IDs to avoid dropping distinct digests.
     *
     * @return string
     */
    public function uniqueId(): string
    {
        $alertHash = sha1(implode(',', $this->alertIds));

        return $this->subscriberId . ':' . $this->date . ':' . $this->digestType . ':' . $alertHash;
    }
